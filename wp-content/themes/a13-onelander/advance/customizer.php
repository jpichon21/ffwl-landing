	...
	switch( $option['type'] ) {
		...
		case 'wp_dropdown_albums':
			...
			if ($r->have_posts()) :
				...
				$args['choices'][0] = esc_html__( 'There are no albums yet!', 'a13-onelander' );
		...
		case 'wp_dropdown_works':
			...
			if ($r->have_posts()) :
				...
				$args['choices'][0] = esc_html__( 'There are no works yet!', 'a13-onelander' );
...
function apollo13framework_customizer_controls_js(){
	...
	$human_variants = array(
		'100' => esc_html__( 'thin', 'a13-onelander' ),
		'200' => esc_html__( 'extra-light', 'a13-onelander' ),
		'300' => esc_html__( 'light', 'a13-onelander' ),
		'400' => esc_html__( 'regular', 'a13-onelander' ),
		'500' => esc_html__( 'medium', 'a13-onelander' ),
		'600' => esc_html__( 'semi-bold', 'a13-onelander' ),
		'700' => esc_html__( 'bold', 'a13-onelander' ),
		'800' => esc_html__( 'extra-bold', 'a13-onelander' ),
		'900' => esc_html__( 'black', 'a13-onelander' ),
	);
