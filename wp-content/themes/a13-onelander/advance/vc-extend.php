...
function vc_gitem_template_attribute_a13_post_body( $value, $data ) {
	...
	if ( post_password_required( $post->ID ) ) {
		...
		$html .= '<h2 class="post-title"><a href="' . esc_url( get_the_permalink( $post->ID ) ) . '"><span class="fa fa-lock"></span>' . esc_html__( 'This content is password protected', 'a13-onelander' ) . '</a></h2>';
		$html .= '<div class="real-content">';
		$html .= '<p>' . esc_html__( 'To view it please enter your password below', 'a13-onelander' ) . '</p>';
