...
<p><span class="info-404"><?php
        ...
        printf( esc_html__('%s or use Site Map below:', 'a13-onelander' ), '<a href="javascript:history.go(-1)">'.esc_html__('Go back', 'a13-onelander').'</a>' ); ?></span></p>

<div class="left50">
    <?php
    if ( has_nav_menu( 'header-menu' ) ){
        echo '<h3>'.esc_html__( 'Main navigation', 'a13-onelander' ).'</h3>';
        wp_nav_menu( array(
                'container'       => false,
                'link_before'     => '',
                'link_after'      => '',
    ...
    <h3><?php esc_html_e( 'Categories', 'a13-onelander' ); ?></h3>
    <ul class="styled">
...
<div class="right50">
    <h3><?php esc_html_e( 'Pages', 'a13-onelander' ); ?></h3>
    <ul class="styled">
    ...
    <?php
        ...
        if ($all_albums->have_posts()) :
            echo '<h3>'.esc_html__( 'Albums', 'a13-onelander' ).'</h3>';
