...
//default template
	...
	$_title = '<span class="fa fa-lock emblem"></span>' . esc_html__( 'This content is password protected.', 'a13-onelander' )
	         .'<br />'
	         .esc_html__( 'To view it please enter your password below', 'a13-onelander' );
